...
**Vendor-neutrality is a release invariant.** No release of Indra's Net names an AI vendor or product, or couples any contract to a specific model. Open frameworks, papers, and standards (MetaGPT, CrewAI, AutoGen, A2A, MCP, Sigstore, in-toto/SLSA, NIST 800-207, DID/VC, SPIFFE, CaMeL/FIDES, MorphAgent, DoWhy, and others) are named only in citation and related-work context. This invariant has held across every release and is a non-negotiable condition on all future ones.
